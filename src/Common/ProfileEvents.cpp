...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(TextIndexDictionaryBlockCacheHits, "Number of times a dictionary block has been found in the cache.", ValueType::Number) \
    M(TextIndexDictionaryBlockCacheMisses, "Number of times a dictionary block has not been found in the cache.", ValueType::Number) \
    M(TextIndexPostingListCacheHits, "Number of times a dictionary block has been found in the cache.", ValueType::Number) \
    M(TextIndexPostingListCacheMisses, "Number of times a dictionary block has not been found in the cache.", ValueType::Number) \
